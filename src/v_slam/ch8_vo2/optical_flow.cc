...
string file_1 = "/home/slam_learn/data/v_ch8/LK1.png";  // first image
string file_2 = "/home/slam_learn/data/v_ch8/LK2.png";  // second image
...
int main(int argc, char **argv) {
    ...
    Mat img1_CV;
    cv::cvtColor(img1, img1_CV, cv::COLOR_GRAY2BGR);
    ...
    cv::imshow("origin by opencv", img1_CV);
