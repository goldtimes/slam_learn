#include "v_slam/vins_init/include/camodocal/chessboard/Chessboard.h"

#include <opencv2/calib3d/calib3d.hpp>
#include <opencv2/imgproc/imgproc.hpp>

#include "v_slam/vins_init/include/camodocal/chessboard/ChessboardQuad.h"
#include "v_slam/vins_init/include/camodocal/chessboard/Spline.h"
    ...
    for (int k = 0; k < 6; ++k) {
        for (int dilations = minDilations; dilations <= maxDilations; ++dilations) {
            ...
            if (flags & cv::CALIB_CB_ADAPTIVE_THRESH) {
                ...
                // convert to binary
                cv::adaptiveThreshold(img, thresh_img, 255, cv::CALIB_CB_ADAPTIVE_THRESH, cv::THRESH_BINARY, blockSize,
                                      (k / 2) * 5);
            } else {
