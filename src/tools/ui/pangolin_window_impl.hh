...
#include "tools/ui/ui_cloud.hh"
#include "tools/ui/ui_traj.hh"
...
class PangolinWindowImpl {
   public:
    ...
    PangolinWindowImpl(PangolinWindowImpl&& other);
   ...
   private:
    ...
    const std::string win_name_ = "SLAM.UI";
    ...
    /// cloud rendering
    UICar car_{Vec3f(0.2, 0.2, 0.8)};                                          // 白色车
